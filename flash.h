...
/*****************************************/
//#define MIN_FREE_BLK_NUM 30
//#define SLC_Hot_Region_ratio 0.75
//#define SLC_Cold_Region_ratio 0.25
//int SLC_cold_start_bound;

// user can use slc nand blk num
int SLC_USER_BLK_NUM;
/************************************
 * Date:09.12.2018
 * Author :zhoujie
...
int total_blk_num;
int total_util_blk_num;
int MIN_FREE_BLK_NUM;
...
int SLC_to_MLC_counts;
int SLC_to_SLC_counts;
...
extern struct SLC_nand_blk_info * SLC_cold_head;
extern struct SLC_nand_blk_info * SLC_cold_tail;
